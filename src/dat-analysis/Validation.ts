import type { Header } from "../dat/models/Header";

import type { ColumnStats } from "./models/ColumnStats";
...
export function validateHeader(
  ...
  if (string) {
    return array ? stats.refArray && stats.refArray.string : stats.refString;
  }
  ...
  if (key && !key.foreign) {
    return array ? stats.refArray && stats.refArray.keySelf : stats.keySelf;
  }
